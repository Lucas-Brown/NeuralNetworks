...
abstract public class Population {
    ...
    class SingleNetwork extends NetworkGroup{
		...
		public double[] calculate(double... input) {
			return this.group[0][0].calculate(input); // only network
		}
    ...
    public static void main(String[] args) {
    	class population extends Population{
			...
			public population(int popSize, int af, double multiplier, int... NETWORK_LAYER_SIZES) {
        ...
        population pop = new population(72, Network.ZERO_TO_ONE, 10.0, 2, 2, 1); // initialize population
        /*
